...
if(isset($_GET['id'])){
	...
	if($queryVerificar){
		...
		if(!(password_verify($_GET['codigo'], $infoVerificar[1]))){
...
<div class="container">
    ...
    <div class="containercentral">
        ...
        <div class="definirsenha">
                ...
                <form name="formsenha" method="POST">
                    <h5>Nova Senha</h5>
                    ...
                    <button type = "submit" name="enviarSenha" class="confirmar" onclick= "return validarSenha()">Confirmar</button>
                </form>
        </div>        
    </div>
</div>
